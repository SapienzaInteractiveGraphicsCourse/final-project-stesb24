...
function createBunker(scene, world) {
    ...
    createWall(wallThickness, houseHeight, houseDepth,
        verticalAxis+houseWidth/2+wallThickness/2, houseHeight/2, horizontalAxis,
        scene, world);
    //West wall
    createWall(wallThickness, houseHeight, houseDepth,
        verticalAxis-houseWidth/2-wallThickness/2, houseHeight/2, horizontalAxis,
        scene, world);
    //North wall    
    createWall(houseWidth, houseHeight, wallThickness,
        verticalAxis, houseHeight/2, horizontalAxis-houseDepth/2+wallThickness/2,
        scene, world);
    //South wall (left)
    createWall((houseWidth-entranceWidth)/2, houseHeight, wallThickness,
        verticalAxis-entranceWidth/4-houseWidth/4, houseHeight/2, horizontalAxis+houseDepth/2-wallThickness/2,
        scene, world);
    //South wall (right)
    createWall((houseWidth-entranceWidth)/2, houseHeight, wallThickness,
        verticalAxis+entranceWidth/4+houseWidth/4, houseHeight/2, horizontalAxis+houseDepth/2-wallThickness/2,
        scene, world);
    //Ceiling
    createWall(houseWidth+2*wallThickness, wallThickness, houseDepth,
        verticalAxis, houseHeight+wallThickness/2, horizontalAxis,
        scene, world);
}
